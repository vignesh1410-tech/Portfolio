const CONFIG = {
  // 1. PERSONAL INFO
  name: "Vicky",
  fullName: "Vignesh Damodaran",
  heroPhoto: "passport_3.jpg",
  role: "Systems Integrator & Product Builder",
  email: "vicki1410vignesh@gmail.com",
  footerText: "Vignesh Damodaran — Built for Vibecon India",
  navSub: "Portfolio",
  year: 2026,
  ...
  processTitle: "Product Development Lifecycle",
  process: [
    {
      title: "Problem Discovery",
      desc: "Find expensive systems, scope affordable replacements — 80% of the value at 20% of the cost."
    },
    {
      title: "Hardware Prototyping",
      desc: "Solve physical constraints first with rapid mechanical and electronic prototypes."
    },
    {
  ...
  // 7. CALL TO ACTION
  ctaTitle: "Ready to build at Vibecon",
  ctaDesc: "I speak mechanics, electronics, and software — eliminating friction to ship products faster. Let's connect at Vibecon India.",
  ctaAccent: "Vibecon",
  ctaPrimary: "Let's Talk Startups",
  ctaSecondary: "View Full Resume"
};
